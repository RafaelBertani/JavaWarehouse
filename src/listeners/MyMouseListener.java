...
public class MyMouseListener implements MouseListener{
    ...
    public void mouseEntered(MouseEvent e) {
        ...
        final JPanel CENTER_PANEL = Screen.getMy_CENTERpanel().getPanel();
        final JPanel LOGS_PANEL = Screen.getMy_LOGSpanel().getPanel();
        ...
        else if(e.getSource()==CENTER_PANEL){
            CENTER_PANEL.setBorder(new LineBorder(Color.BLUE, 2));
        }
        else if(e.getSource()==LOGS_PANEL){
            LOGS_PANEL.setBorder(new LineBorder(Color.BLUE, 2));
        }
    ...
    public void mouseExited(MouseEvent e) {
        ...
        if(e.getSource()==BUTTONS_ADICIONAR){
            ...
            CENTER_PANEL.setBorder(new LineBorder(Color.WHITE, 2));
        }
        else if(e.getSource()==LOGS_PANEL){
            LOGS_PANEL.setBorder(new LineBorder(Color.WHITE, 2));
        }
